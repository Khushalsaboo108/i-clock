    ...
    <div className="space-y-8">
      ...
      <section className="border border-border rounded-lg p-6 bg-card">
        ...
        <div className="space-y-5">
          <div>
            <Label htmlFor="street-address" className="text-sm font-medium text-muted-foreground mb-2 block">
              Street Address
            </Label>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <Label htmlFor="postal-code" className="text-sm font-medium text-muted-foreground mb-2 block">
                Postal Code
              </Label>
              <Input id="postal-code" defaultValue={isNew ? "" : "10001"} className="h-10" />
            </div>
            <div>
              <Label htmlFor="contact-number" className="text-sm font-medium text-muted-foreground mb-2 block">
                Contact Number
              </Label>
          ...
          <div>
            <Label htmlFor="id-number" className="text-sm font-medium text-muted-foreground mb-2 block">
              ID Number
            </Label>
      ...
      <section className="border border-border rounded-lg p-6 bg-card">
        ...
        <div className="space-y-5">
          <div>
            <Label htmlFor="dob" className="text-sm font-medium text-muted-foreground mb-2 block">
              Date of Birth
            </Label>
          ...
          <div>
            <Label htmlFor="marital-status" className="text-sm font-medium text-muted-foreground mb-2 block">
              Marital Status
            </Label>
      ...
      <section className="border border-border rounded-lg p-6 bg-card">
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <Label htmlFor="emergency-contact-person" className="text-sm font-medium text-muted-foreground mb-2 block">
                Contact Person
              </Label>
              <Input id="emergency-contact-person" defaultValue="Jane Smith" className="h-10" />
            </div>
            <div>
              <Label htmlFor="relationship" className="text-sm font-medium text-muted-foreground mb-2 block">
                Relationship
              </Label>
          ...
          <div>
            <Label htmlFor="emergency-contact-number" className="text-sm font-medium text-muted-foreground mb-2 block">
              Contact Number
            </Label>
      ...
      <section className="border border-border rounded-lg p-6 bg-card">
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <Label htmlFor="bank-name" className="text-sm font-medium text-muted-foreground mb-2 block">
                Bank Name
              </Label>
              <Input id="bank-name" defaultValue="Chase Bank" className="h-10" />
            </div>
            <div>
              <Label htmlFor="account-type" className="text-sm font-medium text-muted-foreground mb-2 block">
                Account Type
              </Label>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <Label htmlFor="account-number" className="text-sm font-medium text-muted-foreground mb-2 block">
                Account Number
              </Label>
            ...
            <div>
              <Label htmlFor="routing-number" className="text-sm font-medium text-muted-foreground mb-2 block">
                Routing Number
              </Label>
      ...
      <section className="border border-border rounded-lg p-6 bg-card">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-2">
            <p className="text-xs text-muted-foreground">Character count: 127 / 5000</p>
            <p className="text-xs text-muted-foreground">Last updated by Sarah Johnson on Nov 20, 2024</p>
          </div>
        </div>
      </section>
    </div>
